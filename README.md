...
# auth0 vanilla VueJS boilerplate
This is a refactored version of Scenario #1 of [auth0-vue-samples](https://github.com/auth0-samples/auth0-vue-samples) 
repo that **excludes** the use of typescript.
